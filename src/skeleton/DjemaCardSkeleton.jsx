...
{/* SKELETON WHEN LOADING HEADER DJEMACARD DATA */}
<div className="mt-24">

<div className="flex items-start justify-between flex-wrap">
 <div className="flex items-center flex-wrap">
 <div class="h-2.5 bg-gray-400 ml-16 rounded-full dark:bg-gray-400 animate-pulse w-32 mb-2">
 </div>

 {/* ANOTHER HEADER SKELETON  */}

 <div class="w-52 h-10 animate-pulse  bg-gray-200 ml-8 rounded dark:bg-gray-400">
 </div>
 </div>
 <div className="flex ">
 <div class="w-56 h-10 animate-pulse bg-gray-200 mr-12 rounded dark:bg-gray-400">
 </div>
 <div class="w-56 h-10 animate-pulse bg-gray-200 mr-16 rounded dark:bg-gray-400">
 </div>
...
<div className="flex items-center mt-10 justify-center gap-4 flex-wrap">
...
export default DjemaCardSkeleton