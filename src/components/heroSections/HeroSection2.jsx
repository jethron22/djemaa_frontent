        ...
        <div className='bg-[#1c2d64] text-gray-200' >
            <div className="flex  m-[75px] gap-5 ">
                ...
                <div className='flex flex-col '>
                    ...
                    <p className='text-4xl font-extrabold mb-7'>Djemaa met votre service en avant !</p>
                    <p className='text-2xl font-extrabold '>Faites decouvrir votre travail <span className='italic'>aux milliers</span> des clients chez nous !</p>
